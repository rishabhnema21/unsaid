...
const page = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row  justify-evenly items-center md:min-h-screen bg-[#f8f9fa]">
      ...
      <div className="w-full mb-4 md:mb-0 md:w-1/2 flex flex-col md:flex-row justify-center items-center">
      ...
      <div className="w-[95vw] md:w-1/2 theme-font max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        <div className="text-center">
          ...
          <p className="mb-2 md:mb-4">Sign Up to Start your Anonymous Adventure</p>
        </div>
        ...
        <div className="text-center mt-4">
          <p>
            Already a member?{" "}
            <Link href="/sign-in" className="text-zinc-400 hover:text-zinc-800">
              Sign in
            </Link>
          </p>
        </div>
